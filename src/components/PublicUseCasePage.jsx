...
const USE_CASES = {
  "ai-drafting": {
    ...
    intro:
      "Precedent-backed clause generation drawn from 200,000+ real clauses. Draft, rewrite, and assemble legal documents with AI that knows the needs of Canadian founders.",
    designedFor:
  ...
  "document-storage": {
    ...
    capabilities: [
      ...
      "Collaborative editing — work on the same document with your team in real time",
